...
namespace Practica_clase.Controllers
{
    public class RutinasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Descipción,Duracion")] Rutina rutina)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Descipción,Duracion")] Rutina rutina)
        {
            if (id != rutina.Id)
            {
                return NotFound();
